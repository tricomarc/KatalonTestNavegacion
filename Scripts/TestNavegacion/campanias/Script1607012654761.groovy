...
WebUI.click(findTestObject('Campanias/menuCampanias'))

WebUI.click(findTestObject('Campanias/archivosCampania'))

WS.sendRequest(findTestObject('Campanias/getCampanias'))
