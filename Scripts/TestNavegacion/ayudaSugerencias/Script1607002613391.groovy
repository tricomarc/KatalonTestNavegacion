...
WebUI.click(findTestObject('AyudaSugerencias/menuAyuda'))

WebUI.click(findTestObject('AyudaSugerencias/ayudaSugerencias'))

WS.sendRequest(findTestObject('AyudaSugerencias/getAyudaSugerencias'))

WS.verifyResponseStatusCode(response, 200)

WebUI.focus(findTestObject('AyudaSugerencias/menuAyuda'))

WebUI.click(findTestObject('AyudaSugerencias/tipoAyuda'))

WS.sendRequest(findTestObject('AyudaSugerencias/getTipoAyuda'))
