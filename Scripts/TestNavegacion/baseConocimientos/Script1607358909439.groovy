...
WebUI.click(findTestObject('BaseConocimientos/menuBase'))

WebUI.click(findTestObject('BaseConocimientos/problemas'))

WS.sendRequest(findTestObject('BaseConocimientos/getProblemas'))

WebUI.focus(findTestObject('BaseConocimientos/menuBase'))

WebUI.click(findTestObject('BaseConocimientos/sugerencias'))

WS.sendRequest(findTestObject('BaseConocimientos/getSugerencias'))
