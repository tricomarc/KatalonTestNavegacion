...
WebUI.click(findTestObject('Maquetas/menuMaquetas'))

WebUI.click(findTestObject('Maquetas/ruteros'))

WS.sendRequest(findTestObject('Maquetas/getRuteros'))

WebUI.click(findTestObject('Maquetas/menuMaquetas'))

WebUI.click(findTestObject('Maquetas/normas'))

WS.sendRequest(findTestObject('Maquetas/getNormas'))

WebUI.focus(findTestObject('Maquetas/menuMaquetas'))

WebUI.click(findTestObject('Maquetas/marcaPrecio'))

WS.sendRequest(findTestObject('Maquetas/getMarcaPrecio'))
