...
WebUI.click(findTestObject('AsignacionLaboratorios/menuLaboratorios'))

WebUI.click(findTestObject('AsignacionLaboratorios/laboratorios'))

WS.sendRequest(findTestObject('AsignacionLaboratorios/getLaboratorios'))

WS.verifyResponseStatusCode(response, 200)

WebUI.focus(findTestObject('AsignacionLaboratorios/menuLaboratorios'))

WebUI.click(findTestObject('AsignacionLaboratorios/periodos'))

WS.sendRequest(findTestObject('AsignacionLaboratorios/getPeriodos'))
