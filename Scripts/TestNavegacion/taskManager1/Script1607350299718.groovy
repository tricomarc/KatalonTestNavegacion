...
WebUI.click(findTestObject('TaskManager1/menuTask'))

WebUI.click(findTestObject('TaskManager1/listadoTask'))

WS.sendRequest(findTestObject('TaskManager1/getListadoTask'))

WebUI.focus(findTestObject('TaskManager1/menuTask'))

WebUI.click(findTestObject('TaskManager1/estadisticasTask'))

WS.sendRequest(findTestObject('TaskManager1/getEstadisticasTask'))

WebUI.focus(findTestObject('TaskManager1/menuTask'))

WebUI.click(findTestObject('TaskManager1/tipoTask'))

WS.sendRequest(findTestObject('TaskManager1/getTipoTask'))
