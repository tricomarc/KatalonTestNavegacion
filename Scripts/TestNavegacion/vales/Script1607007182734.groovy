...
WebUI.click(findTestObject('Vales/menuVales'))

WebUI.click(findTestObject('Vales/periodoSeguimiento'))

WS.sendRequest(findTestObject('Vales/getPeriodoSeguimiento'))

WS.verifyResponseStatusCode(response, 200)

WebUI.focus(findTestObject('Vales/menuVales'))

WebUI.click(findTestObject('Vales/cadenas'))

WS.sendRequest(findTestObject('Vales/getCadenas'))

WS.verifyResponseStatusCode(response, 200)

WebUI.focus(findTestObject('Vales/menuVales'))

WebUI.click(findTestObject('Vales/localesCompetencia'))

WS.sendRequest(findTestObject('Vales/getLocalesCompetencia'))

WS.verifyResponseStatusCode(response, 200)

WebUI.focus(findTestObject('Vales/menuVales'))

WebUI.click(findTestObject('Vales/ticketPromedio'))

WS.sendRequest(findTestObject('Vales/getTicketPromedio'))
