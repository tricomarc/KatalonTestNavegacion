...
WebUI.click(findTestObject('Noticias/menuNoticias'))

WebUI.click(findTestObject('Noticias/listaNoticias'))

WS.sendRequest(findTestObject('Noticias/getListaNoticias'))

WebUI.focus(findTestObject('Noticias/menuNoticias'))

WebUI.click(findTestObject('Noticias/categorias'))

WS.sendRequest(findTestObject('Noticias/getCategorias'))
